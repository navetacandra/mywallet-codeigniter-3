        ...
        <table style="display: table; font-size: 1.2rem; font-family: Arial, Helvetica, sans-serif; border-collapse: collapse; width: 100%; height: 40vw;">
            <thead>
                <tr style="background-color: #ffffff;">
                    <th colspan="6" style="text-align: center; border: 1px solid #dddddd; padding: 8px;">INCOMES INVOICE</th>
                </tr>
                <tr>
            ...
            <tbody>
                ...
                ?>
                    <tr <?= $no % 2 == 0 ? 'style="background-color: #dddddd;"' : 'style="background-color: #ffffff;"' ?>>
                        ...
                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?= $income["name"]; ?></td>
                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?= $income["description"]; ?></td>
                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?= $income["type"]; ?></td>
                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?= $income["amount"]; ?></td>
                        <td style="border: 1px solid #dddddd; text-align: left; padding: 8px;"><?= $income["created_at"]; ?></td>
                    </tr>
                <?php
                    $no++;
                }
